// Plantilla de la Factura Fiscal SENIAT de Comercializadora Yeikar.
// Extraída de Ventas.tsx para reutilizarse en el módulo de Facturación.

interface FacturaFiscalPDFProps {
  id: string;
  numero: string;
...
export default function FacturaFiscalPDF({
  id,
  numero,
  numeroControl,
  fechaEmision,
